...
async function deploy() {
    ...
    const mnemonic = "snow unveil ghost grace wood traffic ask board fantasy chef spread bar safe side pear scrap tunnel glide egg delay ankle lesson turtle drill"; // your 24 secret words (replace ... with the rest of the words)
